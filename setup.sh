...
# Create databases directly with pawneemayor user (which has root privileges)
echo "Creating databases..."
docker exec mariadb mysql -u pawneemayor -p"password321" -e "CREATE DATABASE IF NOT EXISTS mediawiki_fresh; CREATE DATABASE IF NOT EXISTS mediawiki_private;"

# Set database names
MAIN_DB_NAME="mediawiki_fresh"
PRIVATE_DB_NAME="mediawiki_private"
echo "Using databases: $MAIN_DB_NAME and $PRIVATE_DB_NAME"
...
mkdir -p /opt/mediawiki/images/resources/sources/
mkdir -p /opt/mediawiki/private/resources/
...
# Copy logo and favicon to private wiki resources (fixed path)
cp /opt/mediawiki/images/resources/sources/logo.png /opt/mediawiki/private/resources/logo.png
cp /opt/mediawiki/images/resources/sources/favicon.ico /opt/mediawiki/private/resources/favicon.ico
